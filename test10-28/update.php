<?php
    ...
    include "db.php";
    $sql = "insert into board set title='{$_POST['title']}',text='{$_POST['text']}'";
				...
				<div class="right_con">	
			        ...
			        <form action="">
                        <div class="update">
                            ...
                            <span>제목:</span><input type="textarea" name="text" id="text" >
                        </div>
                        <p><a href="/update.php">수정완료</a></p>  
                        <p><a href="/view.php">취소</a></p>
                    </form>	
		        </div>	
	        </div>
        </div>
